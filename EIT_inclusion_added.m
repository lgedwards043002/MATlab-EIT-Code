...
% === Load inclusion data only ===
raw = readmatrix('C:\Users\loren\OneDrive\Desktop\EIT DATA\eit_inclusionrun3.csv');
...
title('Inclusion-Only Absolute Reconstruction (E20 → E10)');
colorbar;
...
title('Inclusion-Only 3D Slices (E20 → E10)');

% === Voltage plot (red = measured inclusion)
figure;
plot(vi_meas, 'r', 'LineWidth', 1.3);
title('Inclusion Voltage Measurement (E20 → E10)');
